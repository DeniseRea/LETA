...
\IEEEauthorblockA{\textit{Ciencias de la Computación} \\
\textit{UFA ESPE}\\
Quito, Ecuador \\
...
\begin{itemize}
\item \textbf{IEEE Xplore:} Biblioteca digital de IEEE que indexa publicaciones en ingeniería eléctrica, ciencias de la computación y tecnología (5 artículos recuperados).
\item \textbf{SpringerLink:} Plataforma de publicaciones científicas de Springer Nature con acceso a journals y conference proceedings (3 artículos recuperados).
\item \textbf{Google Scholar:} Motor de búsqueda académico que indexa literatura científica multidisciplinaria (2 artículos recuperados).
...
\begin{quote}
\small{(``machine learning'' OR ``deep learning'' OR ``artificial intelligence'') AND (``software engineering'' OR ``software development'') AND (``enterprise'' OR ``industry'')}
\end{quote}

\item \textbf{SpringerLink:}
\begin{quote}
\small{(``machine learning'' OR ``artificial intelligence'') AND ``software development'' AND (``effort estimation'' OR ``case study'')}
\end{quote}

\item \textbf{Google Scholar:}
\begin{quote}
\small{``generative AI'' AND ``agile'' AND ``software development''}
\end{quote}
\end{enumerate}

\subsubsection{Criterios de Inclusión y Exclusión}

Se establecieron criterios rigurosos para garantizar la calidad y relevancia de los artículos seleccionados.
...
El proceso de gestión bibliográfica se ilustra en las Figuras \ref{fig:zotero} a \ref{fig:importzotero}. La Fig. \ref{fig:zotero} muestra la organización de los artículos en Zotero, mientras que la Fig. \ref{fig:researchrabbit} ilustra el uso de Research Rabbit para explorar redes de citaciones. Adicionalmente, se empleó Connected Papers (Fig. \ref{fig:connectedpapers}) para visualizar relaciones temáticas entre los estudios seleccionados, y la Fig. \ref{fig:importzotero} evidencia el proceso de gestión bibliográfica.

\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\columnwidth]{images/libreria_Zotero.png}
\caption{Biblioteca de referencias en Zotero con los 10 artículos científicos organizados por relevancia y fecha de publicación.}
\label{fig:zotero}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=0.8\columnwidth]{images/Libreria_ResearchRabbit.png}
\caption{Visualización de red de citaciones en Research Rabbit mostrando conexiones entre artículos relacionados.}
\label{fig:researchrabbit}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=0.45\columnwidth]{images/connectedpapers.png}
\caption{Mapa de similitud de Connected Papers evidenciando relaciones temáticas entre los artículos revisados.}
\label{fig:connectedpapers}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=0.45\columnwidth]{images/importar_desde_Zotero.png}
\caption{Proceso de importación y gestión de referencias bibliográficas desde Zotero hacia formato RIS.}
