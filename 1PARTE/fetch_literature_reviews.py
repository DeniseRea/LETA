...
Features:
- Query: SLR/survey/mapping + AI + software development/engineering
- Metadata: title, authors, year, DOI, URL, abstract, open_access flag
- Save results to JSON, CSV, and BibTeX
...
Output files:
- data/literature_reviews.json
- data/literature_reviews.csv
- data/literature_reviews.bib (BibTeX format)
"""
...
OUTPUT_JSON = os.path.join(DATA_DIR, "literature_reviews.json")
OUTPUT_CSV = os.path.join(DATA_DIR, "literature_reviews.csv")
OUTPUT_BIB = os.path.join(DATA_DIR, "literature_reviews.bib")
...
DEFAULT_HEADERS = {
    "User-Agent": "fetch_literature_reviews/1.0 (Educational Research - Literature Review Focused)"
}
...
# Query - Focus on literature reviews (SLR, survey, mapping study) + AI + software development
QUERY = '("systematic literature review" OR "systematic review" OR "SLR" OR "survey" OR "mapping study" OR "systematic mapping" OR "meta-analysis" OR "scoping review" OR "revisión sistemática" OR "estado del arte") AND ("artificial intelligence" OR "machine learning" OR "deep learning" OR "generative AI" OR "inteligencia artificial" OR "aprendizaje automático") AND ("software development" OR "software engineering" OR "desarrollo de software" OR "ingeniería de software")'
...
# Keywords to validate AI relevance (must contain at least one)
AI_KEYWORDS = {
...
# Development related keywords (must contain at least one)
DEVELOPMENT_KEYWORDS = {
    "software development", "software engineering", "development", "devops", "sdlc",
    "software architecture", "code", "testing", "software testing", "build", "deployment"
}
...
def is_literature_review(record: Dict) -> Dict[str, bool]:
    """
    Validate if article is a literature review about AI applied to software development.
    
    Returns dict with flags:
    - review_type: Contains review-type keywords
    - ai: Contains AI keywords
    - development: Contains development keywords
    ...
    for exclude_kw in EXCLUSION_KEYWORDS:
        if exclude_kw.lower() in text_to_check:
            return {"review_type": False, "ai": False, "development": False, "relevant": False}
    ...
    # Relevant if review_type + AI + development
    is_relevant = review_found and ai_found and dev_found
    
    return {
        "review_type": review_found,
        "ai": ai_found,
        "development": dev_found,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Fetch literature reviews (SLRs, surveys) about AI in software development"
    )
